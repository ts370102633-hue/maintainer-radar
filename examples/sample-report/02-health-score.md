...
| --- | --- | ---: | --- |
| README | pass | 8/8 | README.md is present. |
| LICENSE | pass | 5/5 | LICENSE is present. |
| Security policy | pass | 5/5 | SECURITY.md is present. |
| Contributor guide | pass | 4/4 | CONTRIBUTING.md is present. |
| Environment example | pass | 3/3 | .env.example is present. |
| README maintenance usefulness | pass | 3/3 | README signals: install=true, usage=true, maintainer=true. |
| Build script | pass | 5/5 | build script: tsc -p tsconfig.json |
...
| Secret and sensitive file scan | pass | 25/25 | Scanned 49 text files. Critical/high findings=0, medium findings=0. |
...
| Commit history | pass | 3/3 | 9 commits detected. |
